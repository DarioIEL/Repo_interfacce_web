...
1. **Gestione dei Clienti:**
   ...
   - Assegnazione di ogni cliente a un utente dell'applicazione. (COMPLESSO)

2. **Elenco Clienti:**
   - Visualizzazione dell'elenco dei clienti navigando per categoria merceologica, tipologia di cliente, utente assegnato.
...
9. **Visualizzazione di una Dashboard:** 
   - Riepilogo delle informazioni cruciali per ogni utente, inclusi prossimi appuntamenti, note recenti.
